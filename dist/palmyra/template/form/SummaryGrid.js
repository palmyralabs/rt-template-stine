...
function q(e, t, n, a) {
  ...
  let p = W(r, c), d = u && u !== "/" && u.endsWith("/"), l = (s || u === ".") && n.endsWith("/");
  return !p.pathname.endsWith("/") && (d || l) && (p.pathname += "/"), p;
}
