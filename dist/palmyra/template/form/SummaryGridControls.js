...
import { QuickSearch as l, FilterButton as a, ExportDataButton as d } from "@palmyralabs/rt-forms-mui";
...
const h = (r) => {
  ...
  return /* @__PURE__ */ s(u, { children: [
    ...
    /* @__PURE__ */ o(m, { onClick: () => r.newRecord(), ...e.add, className: "py-action-button", children: "Add" })
  ] });
};
export {
